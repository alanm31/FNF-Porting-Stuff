...
class FlxJoyStick extends FlxSpriteGroup
{
	...
	{
		base = new FlxSprite(0, 0).loadGraphic(FlxGraphic.fromFrame(FlxAtlasFrames.fromSparrow(Assetd.getBitmapData('assets/android/joystick.png'), Assetd.getText('assets/android/joystick.xml')).getByName('base')));
	...
	{
		thumb = new FlxSprite(0, 0).loadGraphic(FlxAtlasFrames.fromSparrow(Assetd.getBitmapData('assets/android/joystick.png'), Assetd.getText('assets/android/joystick.xml')).getByName('thumb')));
