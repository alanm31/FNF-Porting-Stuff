...
class AndroidControlsSubState extends FlxSubState
{
	...
	override function create()
	{
		...
		leftArrow.frames = FlxAtlasFrames.fromSparrow(Assetd.getBitmapData('assets/android/menu/arrows.png'), Assetd.getText('assets/android/menu/arrows.xml'));
		leftArrow.animation.addByPrefix('idle', 'arrow left');
		leftArrow.animation.play('idle');
		add(leftArrow);

		rightArrow = new FlxSprite(inputvari.x + inputvari.width + 10, inputvari.y - 25);
		rightArrow.frames = FlxAtlasFrames.fromSparrow(Assetd.getBitmapData('assets/android/menu/arrows.png'), Assetd.getText('assets/android/menu/arrows.xml'));
